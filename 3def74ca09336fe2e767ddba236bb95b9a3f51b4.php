        ...
        <?php $__currentLoopData = $parents->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $children): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="w-full bg-gray-200 text-center border border-gray-300 rounded px-8 py-6 mb-4 <?php echo e(($key>=1) ? 'ml-0 sm:ml-2' : ''); ?> <?php echo e(($parents->children_count===1) ? 'sm:max-w-sm' : ''); ?>">
                <div class="text-gray-700 font-bold">
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('attendance.show',$children->id)); ?>" class="bg-blue-600 inline-block mb-4 text-sm text-white uppercase font-semibold px-4 py-2 border border-gray-400 rounded">Attendence Report</a>
                    </div>
                </div>
            </div>
...
<!-- Log on to codeastro.com for more projects --><?php /**PATH F:\codeastro\Laravel\SchoolSystem-Laravel\resources\views/dashboard/parents.blade.php ENDPATH**/ ?>