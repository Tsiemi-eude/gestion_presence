<?php $__env->startSection('content'); ?>
    <div class="create">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Attendance for class :- <?php echo e($class->class_name); ?></h2>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\CollegeManagementSystem-Laravel\resources\views/backend/attendance/create.blade.php ENDPATH**/ ?>