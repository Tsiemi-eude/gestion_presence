...
Route::get('/classes/{id}/assign-teachers', [ClassController::class, 'assignTeachers'])->name('class.assign.teachers');
Route::post('/classes/{id}/assign-teachers', [ClassController::class, 'storeAssignedTeachers'])->name('class.assign.teachers.store');
