...
@section('content')
    <div class="create">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Présence</h2>
            </div>
        ...
        <div class="w-full mt-8 bg-white rounded">
            ...
            <div class="w-full px-6 py-6">
                <div class="flex items-center justify-between bg-gray-600 rounded-tl rounded-tr">
                    ...
                    <div class="w-3/12 text-left text-white py-2 px-4 font-semibold">Proffeseur</div>
                    <div class="w-3/12 text-left text-white py-2 px-4 font-semibold">Classe</div>
                    <div class="w-3/12 text-right text-white py-2 px-4 font-semibold">Presence</div>
                </div>
